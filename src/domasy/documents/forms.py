...
from domasy.documents.models import DocumentMetadataField, DocumentSpace
from domasy.documents.policies import filter_document_spaces_for_user
...
class DocumentUploadForm(forms.Form):
    ...
    title = forms.CharField(
        ...
        max_length=255,
        required=False,
        help_text="Optional. Wenn leer, versucht DoMaSy den Titel per OCR zu erkennen.",
...
class DocumentSpaceForm(forms.Form):
    ...
    review_assist_enabled = forms.BooleanField(
        label="Prüfhilfe aktivieren",
        required=False,
    ...
    body = forms.CharField(
        ...
        widget=forms.Textarea(
            attrs={
                "class": "form-control",
                "rows": 3,
                "placeholder": "Hinweis zum Dokument erfassen",
            }
        ),
    )
